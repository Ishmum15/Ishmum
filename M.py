...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using LIMON');exit()
...
try:
	prox= requests.get('https://ishmumsarker.blogspot.com/2023/11/approval.html').text
...
def limon2():
        ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/791484986;FBBV/444411021;FBDM/{density=2.25,width=720,height=1280};FBLC/it_IT;FBRV/791484986;FBCR/Nepal Telecom;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-M236L;FBSV/13;nullFBCA/armeabi-v7a:armeabi;FBDM/{density=1.5,641=480,height=1041};FB_FW/1;]'
        return ua

class apvroval:
    def check():
        url = "https://ishmumsarker.blogspot.com/2023/11/approval.html"
        import mechanize
